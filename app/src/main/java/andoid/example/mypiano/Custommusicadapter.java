        ...
        viewHolder.ivPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mediaPlayer.isPlaying()) {
                    mediaPlayer.pause();
                    viewHolder.ivPlay.setImageResource(R.drawable.playawaj);
                } else {
                    mediaPlayer.start();
                    viewHolder.ivPlay.setImageResource(R.drawable.stopsong);
                    Toast.makeText(context.getApplicationContext(), "Tap next blue button to Stop", Toast.LENGTH_LONG).show();
                }
            }
        });
